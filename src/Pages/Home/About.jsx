      ...
      <div className="max-w-330 w-full mx-auto px-3.5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-5 xl:gap-7.5 ">
          ...
          <div className="px-0 lg:px-7.5">
            <h4 className="uppercase text-[#429200] font-semibold text-[16px] md:text-lg xl:text-xl tracking-wide">
              About us
            </h4>
            <h2 className="font-semibold text-[22px]/[26px] sm:text-2xl md:text-[28px] lg:text-3xl xl:text-4xl/tight text-[#242424] my-3 sm:my-5">
              The Future of Energy Starts Here; Turn Sunlight into Savings
            </h2>
            ...
            <div className="grid grid-cols-3 pt-5 pb-5 sm:pb-7.5 border-b border-[#429200]">
              {stats.map((item, index) => (
                <div key={index}>
                  <h3 className="text-[#429200] text-[22px]/[26px] sm:text-2xl md:text-[28px] lg:text-3xl xl:text-4xl font-bold mb-3">
                    {item.number}
                  </h3>
